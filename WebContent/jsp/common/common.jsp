...
//	includeEasyUi+="<link rel='stylesheet' type='text/css' href='"+path+"/skin/js/easyui/themes/icon.css'/>";
	...
	includeEasyUi+="<link rel='stylesheet' href='//cdn.bootcss.com/bootstrap/3.3.5/css/bootstrap.min.css'>";
	// 可选的Bootstrap主题文件（一般不用引入）
	includeEasyUi+="<link rel='stylesheet' href='//cdn.bootcss.com/bootstrap/3.3.5/css/bootstrap-theme.min.css'>";
	//jQuery文件。务必在bootstrap.min.js 之前引入 
	includeEasyUi+="<script src='//cdn.bootcss.com/jquery/1.11.3/jquery.min.js'></script>";
 	//最新的 Bootstrap 核心 JavaScript 文件 
	includeEasyUi+="<script src='//cdn.bootcss.com/bootstrap/3.3.5/js/bootstrap.min.js'></script>";
%>